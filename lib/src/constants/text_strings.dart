...
// -- Welcome Screen Text
const String tWelcomeTitle = "INDustry2U";
const String tWelcomeSubTitle = "To create a mutually beneficially, collaborative business environment for all stakeholders.";
